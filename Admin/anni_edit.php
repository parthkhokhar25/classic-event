...
if (isset($_POST['submit'])) {
    ...
    // Fetch old image if not uploading new one
    $imgQuery = mysqli_query($con, "SELECT img FROM anniversary WHERE id=$id");
        ...
        if ($update) {
            ...
            <script>
                Swal.fire({
                    ...
                    text: 'Anniversary theme updated successfully.',
        ...
        <div class="grid_3 grid_4">
            <div class="tab-content">
                <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" id="anniForm" action="" method="post" enctype="multipart/form-data" onsubmit="return confirmUpdate(event)">
...
function confirmUpdate(e) {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to update this anniversary theme?",
        icon: 'question',
        ...
        if (result.isConfirmed) {
            document.getElementById('anniForm').submit();
        }
    });
}
</script>
